    ...
    <main className="w-full max-w-[480px]">
      <div className="bg-surface-container-lowest rounded-[14px] border border-neutral-medium-gray shadow-[0px_1px_3px_rgba(0,0,0,0.1)] p-[40px] hover:border-accent-blue-light transition-colors duration-200 flex flex-col gap-xl">
        <header className="flex flex-col items-center text-center gap-md">
          ...
          <div>
            <h1 className="font-h1-display text-h1-display text-on-surface mb-xs">
              Welcome back
            </h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-lg">
          <div className="flex flex-col gap-sm">
            <label
              className="font-body-standard text-body-standard text-on-surface"
              htmlFor="email"
            >
              Email
            </label>
            ...
            />
            {errors.email && (
              <p className="text-danger-red text-sm font-body-regular">
                {errors.email}
              </p>
            )}
          </div>
          ...
          <div className="flex flex-col gap-sm">
            <div className="flex items-center justify-between">
              ...
              <Link
                to="/forgot-password"
                className="font-link-standalone text-link-standalone text-[14px] text-primary-container hover:text-primary-blue-dark transition-colors"
              >
                Forgot password?
              </Link>
            </div>
          ...
          {errors.general && (
            <p className="text-danger-red text-sm font-body-regular">{errors.general}</p>
          )}
        ...
        <div className="flex items-center gap-md">
          ...
          <span className="font-label-caption text-label-caption text-on-surface-variant uppercase tracking-wider">
            or continue with
          </span>
          <div className="flex-1 h-px bg-neutral-medium-gray"></div>
        </div>
        ...
        <div className="flex flex-col gap-md">
          <button
            ...
            type="button"
            className="w-full h-[36px] bg-surface-container-lowest text-primary-container border border-neutral-medium-gray rounded-lg font-body-standard text-body-standard flex items-center justify-center gap-sm hover:bg-neutral-off-white hover:border-accent-blue-light transition-all"
          >
            <img
              alt="Google logo icon"
              className="w-4 h-4 object-cover rounded-full"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBJweuhHIbGImTSHg784vk-N7P9jwwk7A0ewbclIALZIwE9GfI6I0LzYX8TmSVUYBObDdexNwOyeOcscf3pcFn3FPdQlkpn_GfeGcwFd9Gz1cC-PzkhuQ4Vv6sqnoSn2r-xiWTjRESCsTp_NDJIBwIdumtj94RteFGHHNjOp0riG4GbAgUya6WH6oIWnRFpF_OJVqEJmu48EAYMeglPOZ72Bc2YH_HMEQniDt6xrUvZIUEoRVZpy5sNP1qpd0f6ZzHnEKQMiQIXt2o"
            />
            Google
          </button>
          <button
          ...
          >
            <img
              ...
              className="w-4 h-4 object-cover rounded-full grayscale"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuAl6FIA_0No7dvixXbdJpmLCyAER9xgDWbi-skRXlT4FY7XO9kY5R_ZLVteYWRManIlpYBhEtZeG-WId2Y7bYfIn2XF5HSfFi0LyXy5C2c3yCpAQ8BtZkNTQVll120nptZguo3mHaAaqroPs_00FYG7rsayxHhd5OmYCqgXec9CzhizJeoenUCZ_2kQ0esD3g_1yzlDt-xlGEdnM78RbN_uERORMXQY0UdpaqsbXxx5VCjroStMqi4tp_8nDYgYpfWg-yPpmwjPgvc"
            />
            GitHub
          </button>
        </div>
        ...
        <footer className="text-center mt-sm">
          <p className="font-body-regular text-body-regular text-on-surface-variant">
            ...
            <Link
              to="/register"
              className="font-link-standalone text-[14px] text-primary-container hover:text-primary-blue-dark transition-colors"
            >
              Create one
            </Link>
          </p>
