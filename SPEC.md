...
- **CV bullet:** _Real-time comment delivery via Socket.IO with per-post rooms; new comments appear without page refresh._
...
- Don't build a trending feed — just the data collection. _"Schema and ingestion ready; ranking deferred"_ is fine.
